...
class Tello:
    ...
    def flipForward(self):
        """ Flip forward. """
        self.flip(Tello_Flip_Type.TELLO_FLIPTYPE_FORWARD.value)

    def flipBackward(self):
        """ Flip backward. """
        self.flip(Tello_Flip_Type.TELLO_FLIPTYPE_BACKWARD.value)

    def flipLeft(self):
        """ Flip Left. """
        self.flip(Tello_Flip_Type.TELLO_FLIPTYPE_LEFT.value)

    def flipRight(self):
        """ Flip Right. """
        self.flip(Tello_Flip_Type.TELLO_FLIPTYPE_RIGHT.value)

    def flipForwardLeft(self):
        """ Flip forward left. """
        self.flip(Tello_Flip_Type.TELLO_FLIPTYPE_FORWARD_LEFT.value)

    def flipForwardRight(self):
        """ Flip forward right. """
        self.flip(Tello_Flip_Type.TELLO_FLIPTYPE_FORWARD_RIGHT.value)

    def flipBackwardLeft(self):
        """ Flip backward left. """
        self.flip(Tello_Flip_Type.TELLO_FLIPTYPE_BACKWARD_LEFT.value)

    def flipBackwardRight(self):
        """ Flip backward right. """
        self.flip(Tello_Flip_Type.TELLO_FLIPTYPE_BACKWARD_RIGHT.value)
...
###############################################################################
    ...
    def parseFlightData(self, buf):
        """ Parse the flight data buffer into a dictionary. """
        flightData = dict()
        bb = ByteBuffer.wrap(buf)

        flightData['BatteryLow'] = bb.get_bool()
        flightData['BatteryLower'] = bb.get_bool()
        flightData['BatteryPercentage'] = bb.get_ULInt8()
        flightData['BatteryState'] = bb.get_bool()
        flightData['CameraState'] = bb.get_ULInt8()
        flightData['DownVisualState'] = bb.get_bool()
        flightData['DroneBatteryLeft'] = bb.get_ULInt16()
        flightData['DroneFlyTimeLeft'] = bb.get_ULInt16()
        flightData['DroneHover'] = bb.get_bool()
        flightData['EmOpen'] = bb.get_bool()
        flightData['EmSky'] = bb.get_bool()
        flightData['EmGround'] = bb.get_bool()
        flightData['EastSpeed'] = bb.get_ULInt16()
        flightData['ElectricalMachineryState'] = bb.get_ULInt16()
        flightData['FactoryMode'] = bb.get_bool()
        flightData['FlyMode'] = bb.get_ULInt8()
        flightData['FlySpeed'] = bb.get_ULInt16()
        flightData['FlyTime'] = bb.get_ULInt16()
        flightData['FrontIn'] = bb.get_bool()
        flightData['FrontLSC'] = bb.get_bool()
        flightData['FrontOut'] = bb.get_bool()
        flightData['GravityState'] = bb.get_bool()
        flightData['GroundSpeed'] = bb.get_ULInt16()
        flightData['Height'] = bb.get_ULInt16()
        flightData['ImuCalibrationState'] = bb.get_ULInt8()
        flightData['ImuState'] = bb.get_bool()
        flightData['LightStrength'] = bb.get_ULInt8()
        flightData['NorthSpeed'] = bb.get_ULInt16()
        flightData['OutageRecording'] = bb.get_bool()
        flightData['PowerState'] = bb.get_bool()
        flightData['PressureState'] = bb.get_bool()
        flightData['SmartVideoExitMode'] = bb.get_ULInt16()
        flightData['TemperatureHeight'] = bb.get_bool()
        flightData['ThrowFlyTimer'] = bb.get_ULInt8()
        flightData['WifiDisturb'] = bb.get_ULInt8()
        flightData['WifiStrength'] = bb.get_ULInt8()
        flightData['WindState'] = bb.get_bool()
